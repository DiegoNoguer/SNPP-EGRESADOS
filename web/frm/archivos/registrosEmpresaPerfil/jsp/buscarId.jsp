...
<%@page import="controladores.RegistrosControladorEmpresa"%>
...
<%
 ...
 registro = RegistrosControladorEmpresa.buscarId(registro);
...
String contenido_detalle = DetallesRegistrosControlador_1.buscarIdRegistro(id_registro);
