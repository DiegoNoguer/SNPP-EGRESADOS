...
function solonumeros(e){
 ...
 function validarFormulario() {
    ...
    var valor = true;
    var nom = $("#nombre_formulario").val();
    var cod = $("#codigo_formulario").val();
    var men = $("#nombre_menu").val();
    ...
    if (nom === "") {
        ...
        $("#nombre_formulario").val("");
        $("#nombre_formulario").focus();
        $("#mensajes").html("El Formulario no puede estar vacio.");
        } else{
            if (cod === "") {
        valor = false;
        $("#codigo_formulario").val("");
        $("#codigo_formulario").focus();
        $("#mensajes").html("El Codigo el Formulario no puede estar vacio.");
        } else{
           if (men === "") {
        valor = false;
        $("#nombre_menu").val("");
        $("#nombre_menu").focus();
        $("#mensajes").html("El Menu no puede estar vacio."); 
        }  
