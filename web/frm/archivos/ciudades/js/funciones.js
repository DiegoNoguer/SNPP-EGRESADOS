...
function buscarIdDepartamento() {
    ...
    $.ajax({
        type: 'POST',
        url: 'jsp/buscarIdDepartamento.jsp',
        data: datosFormulario,
        dataType: 'json',
        beforeSend: function (objeto) {
            $("#mensajes").html("Enviando datos al servidor ...");
...
function buscarNombreDepartamento() {
   ...
   //alert("rr");
    $.ajax({
        type: 'POST',
        url: 'jsp/buscarNombreDepartamento.jsp',
        data: datosFormulario,
        dataType: 'json',
        beforeSend: function (objeto) {
            $("#mensajes").html("Enviando datos al servidor ...");
...
function validarFormularioCiudad() {

    var valor = true;
    var nom = $("#nombre_ciudad").val();
    var log = $("#nombre_departamento").val();
    ...
    if (nom === "") {
        ...
        if (log === "") {
            ...
            $("#nombre_departamento").val("");
            $("#nombre_departamento").focus();
            $("#mensajes").html("El Id Departamento no debe estar vacia.");
        }
    }
    return valor;
}