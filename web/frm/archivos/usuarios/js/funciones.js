    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if(json.nuevo==="true"){
                ...
                //$("#login_usuario").prop('disabled',false);
                $("#id_rol").prop('disabled',false);
                $("#botonBuscarIdRol").prop('disabled',false);
               ...
               // $("#login_usuario").prop('disabled',true);
                $("#id_rol").prop('disabled',true);
                $("#botonBuscarIdRol").prop('disabled',true);
                siguienteCampo("#nombre_usuario","#botonAgregar",false);
            }
        },
           ...
           if (pswd === "") {
               ...
               if (pswd.length < 8) {
                   valor = false;
                    ...
                    $("#password_usuario").val("");
                    $("#password_usuario").focus();
                    $("#mensajes").html("Clave debe ser superior a 8 caracteres.");
                } else {
                        ...
                        if (pswd.search(/[a-z]/) === -1) {
                           ...
                           if (pswd.search(/[0-9]/) === -1) {
                             ...
                             if (rol === "") {
                                ...
                                $("#nombre_rol").val("");
                                $("#nombre_rol").focus();
                               $("#mensajes").html("El id rol no debe estar vacia");
                           }   
                           }
                           return valor;
                       }
